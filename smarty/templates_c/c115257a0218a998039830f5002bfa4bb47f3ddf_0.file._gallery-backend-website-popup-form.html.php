...
/* Smarty version 3.1.32, created on 2018-12-14 05:33:28
  from '/web/sites/afr-app-gallery/smarty/templates/components/_gallery-backend-website-popup-form.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5c1340a80e9b59_13300100',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c115257a0218a998039830f5002bfa4bb47f3ddf' => 
    array (
      0 => '/web/sites/afr-app-gallery/smarty/templates/components/_gallery-backend-website-popup-form.html',
      1 => 1544765608,
      2 => 'file',
    ),
  ),
...
function content_5c1340a80e9b59_13300100 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="row">              
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          <input name="first_name" id="first_name" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['first_name'];?>
" type="text" required/>
        </div>         
      </div>      
      <div class="col-sm-6">
        ...
        <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-user"></i></span>
          <input name="last_name" id="last_name" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['last_name'];?>
" type="text" required/>
        </div>         
      </div>      
    </div>
    ...
    <div class="row mt20">
      <div class="col-sm-6">
        ...
        <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-user"></i></span>
          <input name="display_name" id="display_name" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['display_name'];?>
" type="text" required/>
        </div>         
      </div>      
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          <input name="email_address" id="email_address" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['email_address'];?>
" type="email" required/>
        </div>         
      </div>      
    </div>
    ...
    <div class="row mt20">
      ...
      <div class="input-group">
        <input type="text" id="date_of_birth" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['date_of_birth'];?>
" class="form-control datepicker" name="date_of_birth" placeholder="Date of birth" required>
      ...
      <div class="input-group">
        <span class="input-group-addon"><i class="fa fa-user"></i></span>
        <input name="gallery_name" id="gallery_name" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['gallery_name'];?>
" type="text" required/>
      </div>
      </div>
    </div>
    ...
    <div class="row mt20">
      <div class="col-sm-6">
        ...
        <div class="form-group">
          <input name="phone" id="phone" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['phone'];?>
" type="tel" required/>
        </div>         
      </div>      
      <div class="col-sm-6">
...
"></div>                  
          <input name="languages" id="languages" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['languages'];?>
" type="hidden" />
        </div>  -->        
      </div>      
    </div>
    ...
    <div class="row mt20">
      ...
      <div class="col-sm-6">
        ...
        <div class="input-group">
          ...
          <input name="url_web" id="url_web" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['url_web'];?>
" type="url" required/>
        </div>         
          ...
          <tr>
            ...
            <td style= "width:500px">
              <div class="input-group" style= "width:300px">
                <input name="instagram" id="instagram" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['instagram'];?>
" type="text"/> 
              </div>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style= "width:500px">
              <div class="input-group" style= "width:300px">
                <input name="facebook" id="facebook" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['facebook'];?>
" type="text" />
              </div>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td style= "width:500px">
              <div class="input-group" style= "width:300px">
                <input name="twitter" id="twitter" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['profile']->value['twitter'];?>
" type="text" />
              </div>
            </td>
          </tr>
